...
<div class="flex justify-center">
    <img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/tasks/tts_logmelspectrogram_1_flip.png" alt="Log-mel spectrogram with 80 mel bins"/>
</div>

Side note: When plotting spectrograms as an image using the matplotlib library, the y-axis is flipped and the spectrograms appear upside down. We therefore add `plt.gca().invert_yaxis()` to flip them right side up.
